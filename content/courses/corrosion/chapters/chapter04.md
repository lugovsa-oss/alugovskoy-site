...
הייחודיות של הפוטנציאל מתבטאת בכך שלא ניתן למדוד פוטנציאל באופן מוחלט. על מנת לאפשר שימוש בפוטנציאל, יש לבחור נקודת ייחוס. באופן כללי, נקודת הייחוס יכולה להיות שרירותית, אבל על פי המלצות של IUPAC (האגודה הבינלאומית לכימיה טהורה ויישומית) נבחר כנקודת ייחוס  הפוטנציאל של אלקטרודת המימן התקנית.

![[potentialScales.jpeg]]

היות והפוטנציאל תמיד מיוחס לנקודת ייחוס, ניתן לבנות כמות אינסופית של סקלות פוטנציאל, והערך של פוטנציאל של תהליך מסוים בסקלה אחת יהיה שונה מערכו בסקלה אחרת. יחד עם זאת, הפרש הפוטנציאלים בין שתי תגובות יהיה קבוע ולא תלוי בבחירת הסקלה. ניתן להמיר ערך פוטנציאל בסקלה אחת לערכו בסקלה אחרת על ידי הוספת הפרש הפוטנציאלים בין שתי הסקלות לערך הנמדד. כך לדוגמה, במעבדות נפוץ להשתמש באלקטרודת כסף–כסף כלוריד כאלקטרודת הייחוס המעשית. ההפרש בין סקלת כסף–כסף כלוריד לסקלת המימן התקנית הוא 0.2 וולט (בקירוב). לפיכך, הפוטנציאל של חיזור הנחושת (Cu²⁺/Cu) יהיה 0.54 וולט מול כסף–כסף כלוריד, או 0.34 וולט מול מימן תקני.
מכאן ואילך, כל הפוטנציאלים נמדדים ביחס ל**אלקטרודת המימן הסטנדרטית** (Standard Hydrogen Electrode, SHE), המוגדרת על ידי:
